...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-sidebar text-sidebar-foreground w-[240px] flex-shrink-0 border-r border-sidebar-border",
        className
      )}
      animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                  "fixed h-full w-full inset-0 bg-popover text-popover-foreground p-10 z-[100] flex flex-col justify-between",
                  className
                )}
            >
              <div
